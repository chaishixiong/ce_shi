...
select sample_name, item_l1, standard_value, replace(replace(replace(measured_value, 'mm', ''), '＞', ''),'>','') as measured_value, left(approval_date,7) as date from dwd_zj_taskitem where test_basis like '%GB/T 16915.1-2014%' and item_l1 = '耐热' and measured_value != 'NULL' and measured_value not like '%符合%' and  measured_value != 'mm'  and above_scale_flag =1
or
test_basis like '%GB/T16915.1-2014%' and item_l1 = '耐热' and measured_value != 'NULL' and measured_value not like '%符合%' and  measured_value != 'mm'  and above_scale_flag =1
union all 
select sample_name, item_l1, standard_value, replace(replace(replace(measured_value, 'mm', ''), '＞', ''),'>','') as measured_value, left(approval_date,7) as date from dwd_zj_taskitem where test_basis like '%GB/T 16915.1-2014%' and item_l1 = '耐热' and measured_value != 'NULL' and measured_value not like '%符合%' and  measured_value != 'mm'  and above_scale_flag =1
or
test_basis like '%GB/T16915.1-2014%' and item_l1 = '耐热' and measured_value != 'NULL' and measured_value not like '%符合%' and  measured_value != 'mm'  and above_scale_flag =1
...
test_basis like '%GB/T16915.1-2014%' and item_l1 = '耐热' and measured_value != 'NULL' and measured_value not like '%符合%' and  measured_value != 'mm'  and above_scale_flag =1
union all 
select sample_name, item_l1, standard_value, replace(replace(replace(measured_value, 'mm', ''), '＞', ''),'>','') as measured_value, left(approval_date,7) as date from dwd_zj_taskitem where test_basis like '%GB/T 16915.1-2014%' and item_l1 = '耐热' and measured_value != 'NULL' and measured_value not like '%符合%' and  measured_value != 'mm'  and above_scale_flag =0
or
test_basis like '%GB/T16915.1-2014%' and item_l1 = '耐热' and measured_value != 'NULL' and measured_value not like '%符合%' and  measured_value != 'mm'  and above_scale_flag =0
) t group by t.date order by t.date desc limit 18
            ) a order by a.date
...
def XGBoost(data):
    ...
    data_train1 = data.iloc[0:17]

    data_standard = pd.DataFrame()
    data_standard['date'] = data['date'].iloc[0:18]
    standard_list = []
    for i in range(len(data_standard)):
        standard_list.append(2) #标准值小于2
