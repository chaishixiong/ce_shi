...
class JiKe(object):
    ...
    def re_data(self, data):
        ...
        cleans_data_9 = re.sub(r"(&nbsp;|<sup>|</sup>|</b>|<b>|</i>|<i>)", '', cleans_data_3)
        cleans_data_10 = re.sub(r'<div(.*?)(center">|center" >|center;">|<b>|</b>|left;">)', '', cleans_data_9)
        cleans_data_two = re.sub(r"(<answer.*?answer>)", '', cleans_data_10)
...
if __name__ == "__main__":
    ...
    # def jd_227_geren_sjop_id(self, i):
    #     num = 0
    #     shop_id_list = []
    #     sql = ''
    #     try:
    ...
    #     except:
    #         if num <= 3:
    #             self.jd_227_geren_sjop_id(self, i)
    #         num += 1
