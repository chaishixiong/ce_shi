...
from wenzhou.ji_ke.chu_zhong.settings import tree_ids_dict_shuxue, cookies, re_data, tree_ids_dict_dili
'''
单选，多选，解答题
'''
...
class JiKeYuWen(object):
    ...
    def dict_data(self, data_dict):
        ...
        if len(questions_list) > 0:
            ...
            answer_res = answers_list[0].get('answer_res')  # 答案
            uid = answers_list[0].get('uid')
            self.question_answer(uid, str(answer_res))
    ...
    def question_knowledge(self):
        ...
        for knowledge in knowledge_list:
            ...
            # print(qb_knowledge_list)
            # print('知识点', qb_title_knowledge_list, qb_knowledge_list)
    ...
    def re_data(self, data):
        ...
        cleans_data_10 = re.sub(r'<div(.*?)(center">|center" >)', '', cleans_data_9)
