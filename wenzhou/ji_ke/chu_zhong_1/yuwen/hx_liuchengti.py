...
from wenzhou.ji_ke.chu_zhong.settings import tree_ids_dict_shuxue, cookies, re_data, tree_ids_dict_huaxue
'''
单选，多选，解答题
'''
...
class JiKe(object):
    def __init__(self):
        ...
        self.tree_ids_dict = tree_ids_dict_huaxue
        self.tree_ids = ''
    ...
    def option_values(self, title_id, option_values_list):
        for option_values in option_values_list:
            ...
            data, picture_list = re_data(value)
