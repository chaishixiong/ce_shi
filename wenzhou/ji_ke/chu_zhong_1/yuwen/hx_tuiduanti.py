...
class JiKe(object):
        ...
        try:
            ...
            if len(questions_list) > 0:
                ...
                for answers_str in answers_list:
                    ...
                    answer_res_uid = answers_str.get('uid')
                    self.question_answer(answer_res_uid, answer_res)
                    qb_title_2_data = [answer_res_uid, title_name_data, self.item['item_id']]
    ...
    def question_stem(self, question_stem_data):
        data, picture_list = re_data(question_stem_data)
    ...
    def question_analysis(self):
        ...
        title_id = self.item['item_id']
        hint_data, hint_picture_list = re_data(hint_str)
    ...
    def question_answer(self, id, answer_res):
        answer_data, answer_picture_list = re_data(answer_res)
    ...
    def run_spider(self):
        for self.tree_ids in self.tree_ids_dict.keys():
            if self.tree_ids == '202560':
                page = 0
            # elif self.tree_ids == '202561':
            #     page = 101
            # elif self.tree_ids == '202562':
            #     page = 4
