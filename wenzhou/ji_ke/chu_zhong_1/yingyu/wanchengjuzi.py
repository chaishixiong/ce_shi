...
class JiKeYuWen(object):
    ...
    def dict_data(self, data_dict):
        ...
        if len(options_list) > 0:
            for option_values_l in options_list:
                option_values_lis = option_values_l.get('option_values')
                self.option_values(self.item['item_id'], option_values_lis)
    ...
    def re_data(self, data):
        ...
        cleans_data_13 = re.sub(r'(<i>)|(</i><upoint>|</span>|</rt>)(.*?)(<span>|1em;">|</upoint>)', ' ', cleans_data_12)
