...
class JiKeYuWen(object):
    ...
    def dict_data(self, data_dict):
        ...
        self.item['hint'] = hint
        self.question_analysis(hint, self.item['item_id'])
        return self.item
    ...
    def re_data(self, data):
        ...
        cleans_data_2 = re.sub(r"(<br>|('<br/>))", '', cleans_data_1)
        ...
        cleans_data_11 = re.sub(r'<div(.*?)right" >', '    ', cleans_data_10)
        cleans_data_12 = re.sub(r'<div(.*?)center" >', '', cleans_data_11)
        cleans_data_13 = re.sub(r'(<i>)|(</i><upoint>|</span>|</rt>)(.*?)(<span>|1em;">|</upoint>)', ' ',
                                cleans_data_12)
        cleans_data_two = re.sub(r"(<answer.*?answer>)", '( )', cleans_data_13)
