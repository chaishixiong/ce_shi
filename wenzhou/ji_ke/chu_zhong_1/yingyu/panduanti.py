...
from wenzhou.ji_ke.chu_zhong.settings import tree_ids_dict_yuwen, cookies
'''
单选，多选，解答题
'''
...
class JiKeYuWen(object):
    def __init__(self):
        ...
        self.tree_ids_dict = tree_ids_dict_yuwen
        self.tree_ids = ''
    ...
    def for_questions(self, question_all):
        ...
        if len(questions_list) > 0:
            ...
            answer_res = answers_dict.get('answer_res')[0]
    ...
    def re_data(self, data):
        ...
        cleans_data_4 = re.sub(r'(<uline.*?000">)|(<uline.*?000;">)', '_', cleans_data_3)
        cleans_data_5 = re.sub(r"(</uline>)", '_', cleans_data_4)
        ...
        cleans_data_9 = re.sub(r"(&nbsp;|<sup>|</sup>|</b>|<b>|</i>|<i>)", '', cleans_data_8)
        ...
        cleans_data_12 = re.sub(r'<div(.*?)center" >', '', cleans_data_11)
        cleans_data_13 = re.sub(r'(<i>)|(</i>)', ' ', cleans_data_12)
        cleans_data_two = re.sub(r"(<answer.*?answer>)", '___', cleans_data_13)
