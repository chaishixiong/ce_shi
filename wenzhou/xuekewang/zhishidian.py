...
async def main():
    ...
    # 超时间见 1000 毫秒
    await page.goto('https://www.zxxk.com/soft/26860697.html', options={'timeout': 100000})
    resp_html = page.content()
    await asyncio.sleep(10)
    url = await page.xpath('//*[@class="preview-main"]/img/@data-original')
    # 等待
