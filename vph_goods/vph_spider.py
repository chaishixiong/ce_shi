...
from xie_cheng.xie_cheng.items import XieChengItem
from scrapy.utils.reqser import request_to_dict
from scrapy_redis import picklecompat
from header_tool import headers_todict
                ...
                if match:
                    ...
                    if len(data_info) == 3:
                        ...
                        if name not in city_set:
                            ...
                            page = "1"
                            home_url = "https://hotels.ctrip.com/hotels/listPage?cityename={}&city={}".format(pinyin,
                                                                                                              city_id)
