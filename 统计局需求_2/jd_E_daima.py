...
class GerenAddress(object):
    ...
    def geren_address(self, i, shop_list):
        num = 0
        sql = "SELECT * FROM `jd_goodsinfo_20210{}` where shop_id in {}".format(i, shop_list)
    ...
    def insertion_data(self, i):
        # 202103
        # insertion_sql = "insert into jd_goodsinfo_20210{}_E_zj (shop_id, VID, PID, mian_goods_id, goods_id, bid, brand_name, CID1, CID2, CID3, c_name1, c_name2, c_name3, is_ebook, price, comment, realcomment, goods_name, data_month, E_daima) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)".format(i)
        ...
        # 202105-202110
        # insertion_sql = "insert into jd_goodsinfo_20210{}_E_zj (shop_id, goods_id, mian_goods_id, goods_name, CID3, CID2, CID1, comment, price, good_comment, realcomment, c_name1, c_name2, c_name3, bid, brand_name, data_month, E_daima) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)".format(i)
